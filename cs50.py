...
# # Each # is a decimal digit), remove the leading $, and return the amount as a float. Given $50.00 as input, it should return 50.0.
# percent_to_float, which should accept a str as input (formatted as ##%
# # Each # is a decimal digit), remove the trailing %, and return the percentage as a float. Given 15% as input, it should return 0.15.
# tip.py
